...
namespace cp
{
	FileVisitor::FileVisitor()
	{
		registry.Register<TextComponent>(
			[](IMessageVisitor& _visitor, IMessageComponent& _component, void* _additionnalData) -> void {
				static_cast<FileVisitor&>(_visitor).VisitTextComponent(
		...
		registry.Register<SurroundedComponent>(
			[](IMessageVisitor& _visitor, IMessageComponent& _component, void* _additionnalData) -> void {
				static_cast<FileVisitor&>(_visitor).VisitSurroundedComponent(
	...
	void FileVisitor::VisitTextComponent(const TextComponent& _component, void* _additionnalData)
	{
	...
	void FileVisitor::VisitSurroundedComponent(const SurroundedComponent& _component, void* _additionnalData)
	{
		std::stringstream* ss = static_cast<std::stringstream*>(_additionnalData);
