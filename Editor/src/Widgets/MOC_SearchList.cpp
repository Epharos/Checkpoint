/****************************************************************************
** Meta object code from reading C++ file 'SearchList.hpp'
**
...
#error "The header file 'SearchList.hpp' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject SearchList::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSearchListENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<std::type_index, std::false_type>,
        // method 'Search'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void SearchList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ItemSelected((*reinterpret_cast< std::add_pointer_t<std::type_index>>(_a[1]))); break;
        ...
        {
            using _t = void (SearchList::*)(std::type_index );
            if (_t _q_method = &SearchList::ItemSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchList::ItemSelected(std::type_index _t1)
{
