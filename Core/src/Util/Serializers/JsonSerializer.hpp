...
namespace cp
{
	...
	public:
		...
		void WriteByte(const std::string& _name, const uint8_t& _value) override;
		...
		void WriteByteArray(const std::string& _name, const size_t& _size, const uint8_t* _values) override;
		...
		uint8_t ReadByte(const std::string& _name, const uint8_t& _defaultValue) override;
		...
		std::tuple<size_t, uint8_t*> ReadByteArray(const std::string& _name) override;
